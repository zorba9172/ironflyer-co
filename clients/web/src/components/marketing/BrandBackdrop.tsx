    ...
    <Box
      ...
      sx={{
        ...
        "&::after": {
          ...
          inset: 0,
          background: [
            `linear-gradient(90deg, ${tokens.color.bg.base} 0%, ${tokens.color.bg.base}f2 31%, ${tokens.color.bg.base}91 59%, ${tokens.color.bg.base}f4 100%)`,
            `linear-gradient(180deg, ${tokens.color.bg.base}0d 0%, ${tokens.color.bg.base}d8 82%, ${tokens.color.bg.base} 100%)`,
            `radial-gradient(ellipse 900px 420px at 18% 18%, ${tokens.color.accent.coral}18, ${tokens.color.bg.base}00 70%)`,
            `radial-gradient(ellipse 780px 470px at 92% 13%, ${tokens.color.accent.violet}3a, ${tokens.color.bg.base}00 72%)`,
            `radial-gradient(circle at 1px 1px, ${tokens.color.text.primary}20 1px, ${tokens.color.bg.base}00 1.5px)`,
          ].join(", "),
        ...
        ".ifly-orbital": {
          ...
          background: [
            `radial-gradient(circle at 34% 28%, ${tokens.color.text.primary}4f, ${tokens.color.accent.violet}52 24%, ${tokens.color.bg.surfaceRaised}e8 48%, ${tokens.color.bg.base} 72%)`,
            `linear-gradient(135deg, ${tokens.color.accent.violet}8a, ${tokens.color.bg.base}00 52%)`,
          ].join(", "),
          boxShadow: `0 0 90px ${tokens.color.accent.violet}52, inset -28px -28px 58px ${tokens.color.bg.base}`,
          opacity: 1,
