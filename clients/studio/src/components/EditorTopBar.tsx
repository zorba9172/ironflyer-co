...
import { Box, Button, IconButton, Menu, MenuItem, Stack, ToggleButton, ToggleButtonGroup, Typography } from '@mui/material';
import { useNavigate } from 'react-router-dom';
import { LogoMark } from './LogoMark';
import { AccountMenu } from './AccountMenu';

export type EditorTab = 'preview' | 'map' | 'security' | 'code' | 'dashboard' | 'intelligence' | 'goals' | 'logs' | 'usage' | 'performance' | 'quality';

const DASH_GROUP: EditorTab[] = ['dashboard', 'intelligence', 'quality', 'performance', 'usage', 'logs', 'goals'];
