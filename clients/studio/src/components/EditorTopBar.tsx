...
export type EditorTab = 'preview' | 'dashboard';

export function EditorTopBar({ projectName, tab, onTab }: { projectName: string; tab: EditorTab; onTab: (t: EditorTab) => void }) {
  ...
  return (
    <Box sx={{ display: 'grid', gridTemplateColumns: '1fr auto 1fr', alignItems: 'center', px: 2, height: 56, borderBottom: 1, borderColor: 'divider', bgcolor: 'background.paper' }}>
      ...
      <Stack direction="row" alignItems="center" justifyContent="flex-end" spacing={1}>
        ...
        <Button variant="contained" size="small">Deploy</Button>
      </Stack>
    </Box>
  );
}
