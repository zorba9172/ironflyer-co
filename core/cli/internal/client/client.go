...
//
// Design notes:
//   - All transport goes through `core/cli/internal/gql`, the genqlient-
...
//     with github.com/coder/websocket (already vendored in core/runtime).
...
import (
	...
	"ironflyer/core/cli/internal/gql"
)
