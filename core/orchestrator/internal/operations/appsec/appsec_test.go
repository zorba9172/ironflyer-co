...
func TestInventoryTracksMonorepoDependencyRoots(t *testing.T) {
	inv := BuildInventory(Target{Files: []File{
		...
		{Path: "clients/web/package-lock.json", Content: `{"lockfileVersion":3,"packages":{"node_modules/react":{"version":"19.0.0"}}}`},
	...
	if got := strings.Join(inv.PackageLockPaths, ","); got != "clients/web/package-lock.json" {
...
func TestCycloneDXExportIncludesPackageURLs(t *testing.T) {
	inv := BuildInventory(Target{Files: []File{
		{Path: "clients/web/package-lock.json", Content: `{"lockfileVersion":3,"packages":{"node_modules/@apollo/client":{"version":"3.11.0","dev":false}}}`},
