...
//   - apps/orchestrator/internal/outboxhooks/outboxhooks.go
//   - apps/orchestrator/internal/ledger/postgres.go (ledgerEvent)
//   - apps/orchestrator/internal/wallet/postgres.go (emitWalletEvent)
//   - apps/orchestrator/internal/execution/lifecycle.go (execution.settled.v1)
//   - apps/orchestrator/internal/profitguard/store.go (profitguard.decision.v1)
//   - apps/orchestrator/internal/finisher/gates_security.go (gate.security.finding.v1)
//   - apps/orchestrator/internal/audit/events.go (mandatory audit set)
