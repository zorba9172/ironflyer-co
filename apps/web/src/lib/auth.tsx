...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  // Hydrate again on mount in case SSR pass produced false.
  useEffect(() => {
  ...
  const user = hasToken ? data?.me ?? null : null;
  ...
  const value = useMemo<AuthContextValue>(
    ...
    [user, hasToken, loading, tenantID, signIn, signUp, signOut, refresh],
  );
