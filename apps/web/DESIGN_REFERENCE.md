...
This document codifies the private dark IronFlyer screenshots supplied on 2026-05-25 as the mandatory visual reference for `apps/web`. Use it as the source of truth before changing web UI, CSS, theme tokens, layout primitives, or component density.
