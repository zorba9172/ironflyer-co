// Package sentryext is a thin wrapper around getsentry/sentry-go that lets
// runtime main.go initialise Sentry without duplicating boilerplate. Sentry
// complements OTel — OTel handles spans + metrics, Sentry handles
// exceptions + HTTP panics. Empty DSN short-circuits init to a no-op so
// local boots stay quiet.
package sentryext
