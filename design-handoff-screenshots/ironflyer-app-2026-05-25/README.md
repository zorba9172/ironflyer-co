...
Canonical design work must start from `design-reference/2026-05-25-private-ironflyer/` and `clients/web/DESIGN_REFERENCE.md`. This folder is a historical local screenshot bundle and route map. It must not be silently edited, replaced, or treated as newer than the private dark reference unless the governing design document records a product-owner-approved rebaseline.
